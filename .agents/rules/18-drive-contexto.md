---
description: OBLIGATORIO al consultar Google Drive vía MCP — solo carpetas registradas, solo lectura, consulta dirigida
globs: "vitals/config/drive-context.yaml, vitals/config/drive-context.yaml.example"
alwaysApply: false
---
