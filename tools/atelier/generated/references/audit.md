...
1. **[P?] `/atelier command-name`**: Brief description (specific context from audit findings)
2. **[P?] `/atelier command-name`**: Brief description (specific context)

**Rules**: Only recommend commands from: /atelier adapt, /atelier animate, /atelier audit, /atelier bolder, /atelier clarify, /atelier colorize, /atelier critique, /atelier delight, /atelier distill, /atelier document, /atelier harden, /atelier layout, /atelier onboard, /atelier optimize, /atelier overdrive, /atelier polish, /atelier quieter, /atelier shape, /atelier typeset. Map findings to the most appropriate command. End with `/atelier polish` as the final step if any fixes were recommended.

After presenting the summary, tell the user:

> You can ask me to run these one at a time, all at once, or in any order you prefer.
>
> Re-run `/atelier audit` after fixes to see your score improve.
