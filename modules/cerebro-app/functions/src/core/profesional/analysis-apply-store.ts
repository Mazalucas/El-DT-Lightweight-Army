import type { AnalysisPayload } from '../../shared/types.js';
import type { CerebroStore } from './types.js';
...
export function applyAnalysisToStoreInMemory(
  store: CerebroStore,
  ...
  if (meeting) {
    if (analysis.summary) meeting.summary = analysis.summary;
    if (analysis.actionItems) meeting.actionItems = analysis.actionItems;
