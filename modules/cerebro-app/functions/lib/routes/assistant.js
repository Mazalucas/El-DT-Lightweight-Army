...
assistantRouter.get('/conversations', async (req, res) => {
    try {
...
assistantRouter.get('/conversations/:id', async (req, res) => {
    try {
...
assistantRouter.delete('/conversations/:id', async (req, res) => {
    try {
