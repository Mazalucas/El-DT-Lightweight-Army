...
import { Button, DataTable, EmptyState, ErrorState, PageHeader, Section, Skeleton, toast } from '../ds.js';
import { useBoardView, useInvalidateViews } from '../hooks.js';
  ...
  return (
    <div>
      ...
      <CatalogSection
        ...
        usageLabel="Tareas"
        usage={teamUsage}
        onCreate={(name) => api.createTeam(name)}
        onDelete={(id) => api.deleteTeam(id)}
