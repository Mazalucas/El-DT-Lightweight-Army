...
function orgActions(orgId: string): PeopleActions {
  return {
    ...
    promoteProspect: (id, email, displayName) => api.orgPromoteProspect(orgId, id, email, displayName),
    linkProspect: (prospectId, personId) => api.orgLinkProspect(orgId, prospectId, personId),
