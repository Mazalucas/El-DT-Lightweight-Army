---
dt_command: recordatorio
group: modules
group_title: "Módulos del segundo cerebro"
tagline: "Crear un recordatorio desde el chat (cola local → app web)."
skill: recordatorio
---
...
**En una frase:** Crear un recordatorio desde el chat (cola local → app web).
