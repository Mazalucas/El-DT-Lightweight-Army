---
dt_command: sincronizar-notas-meet
group: modules
group_title: "Módulos del segundo cerebro"
tagline: "Exportar notas Gemini (.gdoc) a Markdown local en el cerebro."
skill: sincronizar-notas-meet
---

# /sincronizar-notas-meet

**Grupo:** Módulos del segundo cerebro
**En una frase:** Exportar notas Gemini (.gdoc) a Markdown local en el cerebro.
