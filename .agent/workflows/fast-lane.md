---
description: "[Trabajo con el framework] Ejecutar alcance cerrado con menos preguntas rutinarias."
...
3. **No** hagas preguntas de validación **rutinarias** ni frenes el avance por el protocolo No cómplice, **excepto**:
   - pedidos que toquen **secretos, credenciales, permisos destructivos** (ver `90-seguridad-secrets.mdc`);
   - ambigüedad de **proyecto Git** en multi-repo (preguntá qué repo; ver `05-multi-project-git.mdc`);
