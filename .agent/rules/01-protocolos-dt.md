---
description: Protocolos obligatorios del DT - Cuestionar, alternativas, puntos ciegos
---
...
Exponer hallazgos y problemas de forma conversacional, no como informe unidireccional:
...
Estructurar respuestas con jerarquía clara:
1. **Objetivo**: qué se busca
2. **Plan**: pasos o enfoque
3. **Ejecución**: cambios concretos
4. **Validación**: cómo verificar

Evitar respuestas desordenadas o sin estructura.
