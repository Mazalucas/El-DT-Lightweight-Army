# Auditorías de seguridad (`/hack`)

Informes del subagente `hack-audit` cuando no hay canvas del IDE.
...
Skill: `.cursor/skills/hack-audit/` · referencia: `docs/03_reference/hack-audit-default.md` (`DOC-REF-010`).
